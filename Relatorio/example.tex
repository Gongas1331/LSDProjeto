...
\def\topfigrule{\kern7.8pt \hrule width\textwidth\kern-8.2pt\relax}
\def\dblfigrule{\kern7.8pt \hrule width\textwidth\kern-8.2pt\relax}
\def\botfigrule{\kern-7.8pt \hrule width\textwidth\kern8.2pt\relax}
...
deselegante). Em geral, quando uma frase termina com uma palavra (ou f\'ormula matem\'atica)
